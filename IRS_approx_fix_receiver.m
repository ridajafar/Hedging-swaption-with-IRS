function [price, delta]=IRS_approx_fix_receiver(mat, freq, S, ZC_curve)
% Computes the approximated price of the IRS (we approximate the PV of the 
% IRS as a long fixed rate bond, with coupons equal to the swap rate 
% and face value equal to the IRS notional, plus a short cash position with 
